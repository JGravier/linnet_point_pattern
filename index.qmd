...
`spatstat.linnet`^[Pour simplifier la lecture, nous parlons dans la suite du texte du package `linnet`.] est un _package_ de la famille de _packages_ `spatstat` consacré à la statistique spatiale et notamment à l'analyse de semis de points.
...
## Rechercher et analyser des concentrations (hot spots)
