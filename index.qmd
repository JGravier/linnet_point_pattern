...
* la longueur totale du réseau (total length)
* le degré maximal (maximum vertex degree)
* la connexité du réseau
* le diamètre 
* le rayon
...
D'autres mesures sont également disponibles :

* degré de chaque sommet (vertexdegree)
* distance entre toutes les paires de sommets (<tt>pairdist(N)</tt>)
