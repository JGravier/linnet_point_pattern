...
# import des fichiers
miniN <- read.table("data/data_mini/mini_node.txt", header=TRUE, row.names = 1,sep=",")
miniE <- read.table("data/data_mini/mini_edge.txt", header = FALSE, sep = ",")
...
```{r}
semis1 <- read.table("data/data_mini/mini_points.txt", header=TRUE,sep=",")
...
semis2 <- read.table("data/data_mini/mini_points2.txt", header=TRUE,sep=",")
