...
*Prendre mini jeu de données et montrer les étapes (objets linnet) et les visu (marks de types différents) (LB)*
...
La dernière étape consiste à intégrer dans le même objet le réseau linéaire et le semis de points à l'aide de la fonction <tt>lpp</tt>.
